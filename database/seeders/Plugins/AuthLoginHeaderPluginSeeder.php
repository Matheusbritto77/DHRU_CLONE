...
class AuthLoginHeaderPluginSeeder extends AbstractPluginSeeder
{
    protected function slug(): string
    {
        return 'auth-login-header';
    }

    protected function definition(): array
    {
        return [
            'name' => 'Cabeçalho de Login',
            'type' => 'custom',
            'is_system' => true,
            'icon' => 'heroicon-o-lock-closed',
            'description' => 'Cabeçalho e branding da página de login.',
            'default_settings' => [
                'eyebrow' => 'Area segura',
                'title' => 'Entre na sua conta',
                'subtitle' => 'Acesse o painel, acompanhe seus pedidos e gerencie seus creditos em um ambiente rapido e confiavel.',
                'logo_src' => 'logo3.jpg',
            ],
