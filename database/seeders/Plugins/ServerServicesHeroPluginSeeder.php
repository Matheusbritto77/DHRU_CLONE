...
class ServerServicesHeroPluginSeeder extends AbstractPluginSeeder
{
    protected function slug(): string
    {
        return 'server-services-hero';
    }

    protected function definition(): array
    {
        return [
            'name' => 'Hero Server Services',
            'type' => 'custom',
            'is_system' => true,
            'icon' => 'heroicon-o-server-stack',
            'description' => 'Cabecalho da pagina de servicos server.',
            'default_settings' => [
                'eyebrow' => 'Server Services',
                'title' => 'Pedidos server com leitura mais simples.',
                'description' => 'Explore os servicos, alterne entre lista e cards, e envie pedidos com os campos dinamicos necessarios em um fluxo mais claro.',
            ],
