<x-app-layout layout="app2">
    ...
    <style>
        ...
        .group-header {
            background-color: #ffffff; /* Cor de fundo do cabeçalho do grupo */
        ...
        .service-table th {
            background-color: #ffffff; /* Cor de fundo do cabeçalho da tabela */
        ...
        .form-select {
            ...
            background-color: #ffffff; /* Fundo branco para input/select */
            border: 1px solid #cbd5e0; /* Bordas cinzas para input/select */
