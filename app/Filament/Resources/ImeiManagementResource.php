...
use App\Filament\Resources\ImeiManagementResource\Pages;
...
class ImeiManagementResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Serviços IMEI';
    protected static ?string $modelLabel = 'Categoria IMEI';
    protected static ?string $pluralModelLabel = 'Categorias IMEI';

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('type', 'IMEI');
    }

    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Section::make('Informações da Categoria IMEI')
                ->schema([
                    Forms\Components\Hidden::make('type')->default('IMEI'),
    ...
    {
        return [
            'index' => Pages\ListImeiManagements::route('/'),
            'create' => Pages\CreateImeiManagement::route('/create'),
            'edit' => Pages\EditImeiManagement::route('/{record}/edit'),
        ];
    }
}
