...
{
    protected static ?string $model = server_services::class;
    protected static ?string $navigationIcon = 'heroicon-o-document-magnifying-glass';
    protected static ?string $navigationGroup = 'Relatórios / Ordens';
    protected static ?string $navigationLabel = 'Ordens Server';
    protected static ?string $modelLabel = 'Ordem Server';
    protected static ?string $pluralModelLabel = 'Ordens Server';
